...
bloomingPool
	...
	.then(function() {
		var i
		for (i = 0; i < 101; i++) {
			tx = buyable._mint(web3.eth.accounts[0], i)
	...
	.then(function(instance) {
		console.log(`\nROLE of coinbase: ${instance.toNumber()} (2 is ADMIN) `)
	})
	.then(function() {
	...
	.then(function() {
		...
		console.log(
			'Initialised state variables of BUYABLE CONTRACT for BLOOMING POOL and INFRASTRUCTURE POOL payouts'
		)
	})
	.then(function() {
		process.exit()
